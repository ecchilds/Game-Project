...
@rem ##########################################################################
@rem
@rem  testGame startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and TEST_GAME_OPTS to pass JVM options to this script.
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TEST_GAME_OPTS%  -classpath "%CLASSPATH%"  %*
...
:fail
rem Set variable TEST_GAME_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%TEST_GAME_EXIT_CONSOLE%" exit 1
exit /b 1
